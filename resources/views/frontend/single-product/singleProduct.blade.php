        ...
        <div class="container">
            <div class="row mt-30">
                <ul>
                    ...
                    <li class="float-left mx-2 font-weight-bold"><a href="#" >Category</a></li>
                    <li class="float-left mx-2 mt-cs-1"><span><i class="ti-angle-double-right"></i></span></li>
                    <li class="float-left font-weight-bold"><a href="#" >Subcategory</a></li>
                </ul>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-6 col-12 mb-50">
                    ...
                    <div class="single-product-image thumb-left">
                        ...
                        <div class="tab-content">
                            <div id="single-image-1" class="tab-pane fade show active ">
                                <div class=""><a href="{{ asset('/') }}frontEnd/assets/images/single-product/big-1.png" class=""><img id="img_01" src="{{ asset('/') }}frontEnd/assets/images/single-product/big-1.png" data-zoom-image="{{ asset('/') }}frontEnd/assets/images/single-product/big-1.png" alt="Big Image" class="w-100"></a></div>
                            </div>
                            <div id="single-image-2" class="tab-pane fade ">
                                <div class=""><a href="{{ asset('/') }}frontEnd/assets/images/single-product/big-7.png" class=""><img id="img_02" src="{{ asset('/') }}frontEnd/assets/images/single-product/big-7.png" data-zoom-image="{{ asset('/') }}frontEnd/assets/images/single-product/big-7.png" alt="Big Image" class="w-100"></a></div>
                            </div>
                            <div id="single-image-3" class="tab-pane fade ">
                                <div class=""><a href="{{ asset('/') }}frontEnd/assets/images/single-product/big-13.png" class=""><img id="img_03" src="{{ asset('/') }}frontEnd/assets/images/single-product/big-13.png" data-zoom-image="{{ asset('/') }}frontEnd/assets/images/single-product/big-13.png" alt="Big Image" class="w-100"></a></div>
                            </div>
                        </div>

                        <div class="thumb-image-slider nav" data-vertical="true">
                            <a class="thumb-image active" data-toggle="tab" href="#single-image-1"><img src="{{ asset('/') }}frontEnd/assets/images/single-product/big-1.png" alt="Thumbnail Image" class="w-100"></a>
                            <a class="thumb-image" data-toggle="tab" href="#single-image-2"><img src="{{ asset('/') }}frontEnd/assets/images/single-product/big-7.png" alt="Thumbnail Image"></a>
                            <a class="thumb-image" data-toggle="tab" href="#single-image-3"><img src="{{ asset('/') }}frontEnd/assets/images/single-product/big-13.png" alt="Thumbnail Image"></a>
                        </div>
                        ...
                        <div class="tab-pane fade show active" id="product-description">
                            ...
                            <div class="row">
                                ...
                                <div class="single-product-description-image col-lg-4 col-12">
                                    <img src="{{ asset('/') }}frontEnd/assets/images/single-product/description.png" alt="description">
                                </div>
                            </div>
