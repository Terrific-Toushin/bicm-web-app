                ...
                <div class="col-lg-8 m-auto">
                    ...
                    <div class="senior_designer_item">
                        <div class="senior_right">
                                                ...
                                                <div class="senior_right_text">
                                                    ...
                                                    <div class="file">
                                                        <ul>
                                                            ...
                                                            <li><a href="#">2 Year Experience</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <p>
                                Understanding your vision means a lot to us. So, we start with getting the sense of the project, its dynamics as well as technological requirements s and most importantly your demands and expectations to perfectly outline the structure, specifications
                                and probable duration of your project.
                            </p>
                            <div class="btn_item">
                                <div class="row">
                                    <div class="col-lg-6">
