...
{{--                        <h3>MSc in Mathematics and Foundations of Computer Science</h3>--}}
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <a href="{{url('pages/program-apply/'.$pageDetails->page_id.'/'.$pageDetails->course_id)}}" class="btn btn-info enroll_now" title="Enroll Courses">Apply Now</a>
                            </div>
                        </div>
                        ...
                        <div class="controls">
                            <ul class="nav nav-tabs">
                                @if($pageDetails->aboutShow == 'Y')
                                    <li class="active"><a  class="active" data-toggle="tab" href="#about">{{$pageDetails->aboutHeading}}</a>
                                @endif
                                @if($pageDetails->pedagogyShow == 'Y')
                                    <li><a data-toggle="tab" href="#pedagogy">{{$pageDetails->pedagogyHeading}}</a></li>
                                @endif
                                @if($pageDetails->courseStructureShow == 'Y')
                                    <li><a data-toggle="tab" href="#cstructure">{{$pageDetails->courseHeading}}</a></li>
                                @endif
                                @if($pageDetails->teachingMethodsShow == 'Y')
                                    <li><a data-toggle="tab" href="#tmethods">{{$pageDetails->teachingHeading}}</a></li>
                                @endif
                                @if($pageDetails->gradingPolicyShow == 'Y')
                                    <li><a data-toggle="tab" href="#gpolicy">{{$pageDetails->gradingPolicyHeading}}</a></li>
                                @endif
                                @if($pageDetails->feesChargesShow == 'Y')
                                    <li><a data-toggle="tab" href="#fees">{{$pageDetails->feesChargesHeading}}</a></li>
                                @endif
                                @if($pageDetails->downloadShow == 'Y')
                                    <li><a data-toggle="tab" href="#download">{{$pageDetails->downloadHeading}}</a></li>
                                @endif
