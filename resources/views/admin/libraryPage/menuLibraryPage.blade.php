        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('libraryPage')}}">Library Page</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <a href="#">Menu</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form  class="form-horizontal form-row-seperated" method="POST" action="{{ route('librarySettingPage') }}" enctype="multipart/form-data" name="libraryMenu">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                @if(!empty($librarySettings))
                                    <input type="hidden" class="form-control" name="library_settings_id" value="{{$librarySettings->library_settings_id}}" placeholder="">
                                @endif

                            </div>
                            @if(!empty($librarySettings->banner))
                                <div class="col-md-6">
                                    <label class="col-md-2 control-label">Current Image</label>
                                    <img src="{{asset($librarySettings->banner)}}" style="width: 200px; height: 150px;">
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="tittle" value="{{!empty($librarySettings) ? $librarySettings->tittle : ''}}" placeholder="Page Tittle" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="url" value="{{!empty($librarySettings->url) ? $librarySettings->url : ''}}" placeholder="Page end url" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                                <textarea class="ckeditor form-control" name="description"
                                                          rows="4">{{!empty($librarySettings->description) ? $librarySettings->description : ''}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select class="form-control input-medium select2me"
                                    ...
                                    <option value=""></option>
                                    <option value="Y" {{!empty($librarySettings->status) && $librarySettings->status == 'Y' ? 'selected' : ''}}>Show</option>
                                    <option value="N" {{!empty($librarySettings->status) && $librarySettings->status == 'N' ? 'selected' : ''}}>Inactive</option>
                                </select>
                            </div>
                        </div>
