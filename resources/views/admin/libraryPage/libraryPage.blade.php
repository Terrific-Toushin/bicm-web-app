        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('libraryPage')}}">Library Pages Edit</a>
                    </li>
                </ul>
            </div>
            <!-- END PAGE HEADER-->
                    ...
                    <div class="form-horizontal form-row-seperated">
                        <div class="portlet">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-shopping-cart"></i>Library Pages
                                </div>
                            </div>
                                    ...
                                    <div class="tab-content no-space">
                                        <div class="tab-pane active" id="tab_general">
                                            <div class="text-align-reverse margin-bottom-10">
                                                <a href="{{route('newLibraryMenu', ['id' => 'new'])}}" class="btn yellow">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                @foreach($librarySettings as $library)
                                                    <tr>
                                                        <td>
                                                            <a href="#" class="fancybox-button"
                                                               data-rel="fancybox-button">
                                                                <img class="img-responsive"
                                                                     src="{{asset($library->banner)}}" alt="">
                                                            </a>
                                                        </td>
                                                        <td>{{$library->tittle}}</td>
                                                        <td>{{$library->url}}</td>
                                                        <td>{{$library->status == 'Y' ? "show" : "Hide" }}</td>
                                                        <td>
                                                            <a href="{{ route('newAboutMenu', ['id' => $library->library_settings_id]) }}"
