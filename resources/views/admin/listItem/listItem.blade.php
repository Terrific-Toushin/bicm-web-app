        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('listItem')}}">List Item Edit</a>
                    </li>
                </ul>
            </div>
            <!-- END PAGE HEADER-->
                    ...
                    <div class="form-horizontal form-row-seperated">
                        <div class="portlet">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-shopping-cart"></i>List Item
                                </div>
                            </div>
                                    ...
                                    <div class="tab-content no-space">
                                        <div class="tab-pane active" id="tab_general">
                                            <div class="text-align-reverse margin-bottom-10">
                                                <a href="{{route('newListItem', ['id' => 'new'])}}" class="btn yellow">
                                                    <i class="fa fa-plus"></i> Add List Item</a>
                                            </div>
                                            <table class="table table-bordered table-hover">
                                                ...
                                                @foreach($listItems as $listItem)
                                                    <tr>
                                                        ...
                                                        <td>{{$listItem->tittle}}</td>
                                                        <td>{{$listItem->page_name}}</td>
                                                        <td>{{$listItem->status == 'Y' ? "show" : "Hide" }}</td>
                                                        <td>
                                                            <a href="{{ route('newListItem', ['id' => $listItem->list_id]) }}"
