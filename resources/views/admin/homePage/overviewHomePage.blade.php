...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form  class="form-horizontal form-row-seperated" method="POST" action="{{ route('homeOverviewPage') }}" enctype="multipart/form-data" name="overview">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                @if(!empty($homeOverview))
                                    <input type="hidden" class="form-control" name="home_overview_id" value="{{$homeOverview->home_overview_id}}" placeholder="">
                                @endif

                            </div>
                            @if(!empty($homeOverview->image))
                                <div class="col-md-6">
                                    <label class="col-md-2 control-label">Current Image</label>
                                    <img src="{{asset($homeOverview->image)}}" style="width: 200px; height: 150px;">
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="tittle" value="{{!empty($homeOverview) ? $homeOverview->tittle : ''}}" placeholder="Page Tittle" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control" name="shortDescription">{{!empty($homeOverview->shortDescription) ? $homeOverview->shortDescription : ''}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="url" value="{{!empty($homeOverview->url) ? $homeOverview->url : ''}}" placeholder="Page end url" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select class="form-control input-medium select2me"
                                    ...
                                    <option value=""></option>
                                    <option value="Y" {{!empty($homeOverview->status) && $homeOverview->status == 'Y' ? 'selected' : ''}}>Show</option>
                                    <option value="N" {{!empty($homeOverview->status) && $homeOverview->status == 'N' ? 'selected' : ''}}>Inactive</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2"><input type="checkbox" class="icheck" {{!empty($homeOverview->aboutShow) && $homeOverview->aboutShow == 'Y' ? 'checked' : ''}}
                                data-checkbox="icheckbox_flat-grey"
                                                                         name="aboutShow" value="Y">
                                About </label>
                            <div class="col-md-10">
                                                <textarea class="ckeditor form-control" name="about"
                                                          rows="4">{{!empty($homeOverview->about) ? $homeOverview->about : ''}}</textarea>
                            </div>
                        </div>
