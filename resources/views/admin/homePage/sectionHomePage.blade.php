            ...
            <div class="row">
                <div class="col-md-12">
                    <form  class="form-horizontal form-row-seperated" method="POST" action="{{ route('homeSettingPage') }}" enctype="multipart/form-data" name="homeSettings">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">Pop Up Image:</label>
                            <div class="col-md-3">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div>
                                                                    <span class="btn default btn-file">
                                                                        <span class="fileinput-new">Select image </span>
                                                                        <span class="fileinput-exists">Change </span>
                                                                        <input type="file" class="form-control" name="popImage" placeholder="" accept="image/*">
                                                                    </span>
                                        <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput">Remove </a>
                                    </div>
                                </div>
                            ...
                            @if(!empty($homeSettings->popImage))
                                <div class="col-md-6">
                                    ...
                                    <img src="{{asset($homeSettings->popImage)}}" style="width: 200px; height: 150px;">
                                </div>
                            @endif
