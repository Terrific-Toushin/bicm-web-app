...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form  class="form-horizontal form-row-seperated" method="POST" action="{{ route('homeServicePage') }}" enctype="multipart/form-data" name="service">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                @if(!empty($homeService))
                                    <input type="hidden" class="form-control" name="home_service_id" value="{{$homeService->home_service_id}}" placeholder="">
                                @endif
                            ...
                            @if(!empty($homeService->image))
                                <div class="col-md-6">
                                    ...
                                    <img src="{{asset($homeService->image)}}" style="width: 200px; height: 150px;">
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="tittle" value="{{!empty($homeService) ? $homeService->tittle : ''}}" placeholder="Page Tittle" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control" name="shortDescription">{{!empty($homeService->shortDescription) ? $homeService->shortDescription : ''}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="url" value="{{!empty($homeService->url) ? $homeService->url : ''}}" placeholder="Page end url" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select class="form-control input-medium select2me"
                                    ...
                                    <option value=""></option>
                                    <option value="Y" {{!empty($homeService->status) && $homeService->status == 'Y' ? 'selected' : ''}}>Show</option>
                                    <option value="N" {{!empty($homeService->status) && $homeService->status == 'N' ? 'selected' : ''}}>Inactive</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2"><input type="checkbox" class="icheck" {{!empty($homeService->aboutShow) && $homeService->aboutShow == 'Y' ? 'checked' : ''}}
                                data-checkbox="icheckbox_flat-grey"
                                                                         name="aboutShow" value="Y">
                                About </label>
                            <div class="col-md-10">
                                                <textarea class="ckeditor form-control" name="about"
                                                          rows="4">{{!empty($homeService->about) ? $homeService->about : ''}}</textarea>
                            </div>
                        </div>
